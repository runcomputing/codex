...
impl PartialEq for CacheKey {
    fn eq(&self, other: &Self) -> bool {
        self.source == other.source
            ...
            && self.cell_size.width == other.cell_size.width
            && self.cell_size.height == other.cell_size.height
    }
}
...
fn resize_for_terminal(
    ...
    let terminal_width = u32::from(available_columns).checked_mul(u32::from(cell_size.width))?;
    let terminal_height = u32::from(available_rows).checked_mul(u32::from(cell_size.height))?;
